...
const TestimonialsCarousel: React.FC = () => {
  const items = [
    ...
    { name: "John Okafor", role: "Corps Corper", quote: "Practical coaching and workplace skills helped me secure a placement immediately after service." },
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <aside className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100
           h-fit sticky top-16">
            <h4 className="text-2xl font-black text-gray-900 mb-4">Why Students Choose Zeteo</h4>
